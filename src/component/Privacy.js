    ...
    render(){
        ...
        return(
            <div className="container privacy-container">
                ...
                <h3 className="privacy-h3">プライバシーポリシー</h3>
                <div className='privacy-content'>
                    株式会社Akushu（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。） における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
                    <h4>第1条（個人情報）</h4>
